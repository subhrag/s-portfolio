window.onload = function() {
    ...
    function displaySkills() {
        const skill_images = ['img/java-logo.png', 'img/spring-logo.png', 'img/api-logo.png', 'img/maven-logo.png', 'img/oracle-logo.png', 'img/hibernate-logo.png', 'img/junit-logo.png', 'img/html5-logo.png', 'img/js-logo.png', 'img/css-logo.png', 'img/sass-logo.png', 'img/webpack-logo.png', 'img/gulp-logo.png', 'img/grunt-logo.png', 'img/xml-logo.png', 'img/GitHub-logo.png', 'img/eclipse-logo.png', 'img/vscode-logo.png'];
